...
test "query_metrics" "$(dfx canister call archive_swap query_metrics 2>&1)" '( record { stable_memory_pages = 1_025 : nat64; stable_memory_bytes = 67_174_400 : nat64; heap_memory_bytes = 1_245_184 : nat64; last_upgrade_time_seconds = 0 : nat64; max_memory_size_bytes = 200 : nat64; blocks = 1 : nat64; blocks_bytes = 65 : nat64; block_height_offset = 0 : nat64; }, )'
...
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_query" "$(dfx canister call archive_swap permission_query 2>&1)" '( vec { "PauseQuery"; "PauseReplace"; "PermissionQuery"; "PermissionFind"; "PermissionUpdate"; "RecordFind"; "RecordMigrate"; "ScheduleFind"; "ScheduleReplace"; "ScheduleTrigger"; "BusinessExampleQuery"; "BusinessExampleSet";}, )'
test "permission_update" "$(dfx --identity bob canister call archive_swap permission_update "(vec { variant { UpdateUserPermission=record{principal \"$ALICE\"; opt vec { \"PermissionUpdate\";\"PermissionQuery\" } } } })" 2>&1)" "'PermissionUpdate' is required"
test "permission_update" "$(dfx canister call archive_swap permission_update "(vec { variant { UpdateUserPermission=record{principal \"$ALICE\"; opt vec { \"PermissionUpdate\";\"PermissionQuery\" } } } })" 2>&1)" "()"
test "🙈 permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" "'PermissionQuery' is required"
test "permission_query" "$(dfx canister call archive_swap permission_query 2>&1)" '( vec { "PauseQuery"; "PauseReplace"; "PermissionQuery"; "PermissionFind"; "PermissionUpdate"; "RecordFind"; "RecordMigrate"; "ScheduleFind"; "ScheduleReplace"; "ScheduleTrigger"; "BusinessExampleQuery"; "BusinessExampleSet";}, )'
test "permission_find_by_user" "$(dfx canister call archive_swap permission_find_by_user "(principal \"$ALICE\")" 2>&1)" '(vec { "PauseQuery"; "PermissionUpdate"; "BusinessExampleQuery" })'
test "permission_update" "$(dfx --identity alice canister call archive_swap permission_update "(vec { variant { UpdateUserPermission=record{principal \"$ALICE\"; null } } })" 2>&1)" "()"
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_query" "$(dfx canister call archive_swap permission_query 2>&1)" '( vec { "PauseQuery"; "PauseReplace"; "PermissionQuery"; "PermissionFind"; "PermissionUpdate"; "RecordFind"; "RecordMigrate"; "ScheduleFind"; "ScheduleReplace"; "ScheduleTrigger"; "BusinessExampleQuery"; "BusinessExampleSet";}, )'
...
test "permission_query" "$(dfx canister call archive_swap permission_query 2>&1)" '( vec { "PauseQuery"; "PauseReplace"; "PermissionQuery"; "PermissionFind"; "PermissionUpdate"; "RecordFind"; "RecordMigrate"; "ScheduleFind"; "ScheduleReplace"; "ScheduleTrigger"; "BusinessExampleQuery"; "BusinessExampleSet";}, )'
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_find_by_user" "$(dfx canister call archive_swap permission_find_by_user "(principal \"$DEFAULT\")" 2>&1)" '( vec { "PauseQuery"; "PauseReplace"; "PermissionQuery"; "PermissionFind"; "PermissionUpdate"; "RecordFind"; "RecordMigrate"; "ScheduleFind"; "ScheduleReplace"; "ScheduleTrigger"; "BusinessExampleQuery"; "BusinessExampleSet";}, )'
test "permission_find_by_user" "$(dfx canister call archive_swap permission_find_by_user "(principal \"$ALICE\")" 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_find_by_user" "$(dfx --identity alice canister call archive_swap permission_find_by_user "(principal \"$DEFAULT\")" 2>&1)" "'PermissionFind' is required"
test "permission_find_by_user" "$(dfx --identity alice canister call archive_swap permission_find_by_user "(principal \"$ALICE\")" 2>&1)" "'PermissionFind' is required"

blue "\n🚩 1.3 permission roles"
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_update" "$(dfx canister call archive_swap permission_update "(vec { variant { UpdateRolePermission=record{\"Admin\"; opt vec {\"PauseReplace\"; \"PauseQuery\"} } } })" 2>&1)" "()"
test "permission_update" "$(dfx canister call archive_swap permission_update "(vec { variant { UpdateUserRole=record{principal \"$ALICE\"; opt vec {\"Admin\"} } } })" 2>&1)" "()"
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseReplace"; "PermissionQuery"; "BusinessExampleQuery" })'
test "permission_update" "$(dfx canister call archive_swap permission_update "(vec { variant { UpdateUserRole=record{principal \"$ALICE\"; null } } })" 2>&1)" "()"
test "permission_query" "$(dfx --identity alice canister call archive_swap permission_query 2>&1)" '(vec { "PauseQuery"; "PermissionQuery"; "BusinessExampleQuery" })'

blue "\n🚩 2.1 pause permission"
test "pause_query" "$(dfx canister call archive_swap pause_query 2>&1)" "(false)"
test "pause_query_reason" "$(dfx canister call archive_swap pause_query_reason 2>&1)" "(null)"
...
test "pause_query_reason" "$(dfx canister call archive_swap pause_query_reason 2>&1)" "message = \"reason\""

blue "\n🚩 2.2 pause permission by alice"
test "pause_query" "$(dfx --identity alice canister call archive_swap pause_query 2>&1)" "(true)"
test "pause_query_reason" "$(dfx --identity alice canister call archive_swap pause_query_reason 2>&1)" "message = \"reason\""

blue "\n🚩 2.3 pause no permission"
test "pause_replace" "$(dfx --identity alice canister call archive_swap pause_replace "(null)" 2>&1)" "'PauseReplace' is required"
test "permission_update" "$(dfx canister call archive_swap permission_update "(vec { variant { UpdateUserPermission=record{principal \"$ALICE\"; opt vec { \"PauseReplace\";\"PauseQuery\" } } } })" 2>&1)" "()"
test "pause_replace" "$(dfx --identity alice canister call archive_swap pause_replace "(null)" 2>&1)" "()"
test "pause_query" "$(dfx --identity alice canister call archive_swap pause_query 2>&1)" "'PauseQuery' is required"
test "pause_query_reason" "$(dfx --identity alice canister call archive_swap pause_query_reason 2>&1)" "'PauseQuery' is required"
test "pause_query" "$(dfx canister call archive_swap pause_query 2>&1)" "(false)"
test "pause_query_reason" "$(dfx canister call archive_swap pause_query_reason 2>&1)" "(null)"

blue "\n🚩 3 record no permission"
test "record_topics" "$(dfx --identity alice canister call archive_swap record_topics 2>&1)" "'RecordFind' is required"
test "record_topics" "$(dfx canister call archive_swap record_topics 2>&1)" '"Example"' '"CyclesCharge"'
test "record_find_by_page" "$(dfx canister call archive_swap record_find_by_page "(record{page=1:nat64;size=1:nat32},opt record{topic=opt vec{\"Pause\"}})" 2>&1)" "record { total = "
test "record_migrate" "$(dfx canister call archive_swap record_migrate "(1:nat32)" 2>&1)" "removed = 0"

blue "\n🚩 4 schedule"
test "schedule_find" "$(dfx --identity alice canister call archive_swap schedule_find 2>&1)" "'ScheduleFind' is required"
test "schedule_find" "$(dfx canister call archive_swap schedule_find 2>&1)" "(null)"
test "schedule_replace" "$(dfx --identity alice canister call archive_swap schedule_replace "(opt (1000000000:nat64))" 2>&1)" "'ScheduleReplace' is required"
test "schedule_replace" "$(dfx canister call archive_swap schedule_replace "(opt (1000000000:nat64))" 2>&1)" "()"
sleep 3
test "schedule_replace" "$(dfx canister call archive_swap schedule_replace "(null)" 2>&1)" "()"
sleep 2
test "schedule_trigger" "$(dfx --identity alice canister call archive_swap schedule_trigger 2>&1)" "'ScheduleTrigger' is required"
test "schedule_trigger" "$(dfx canister call archive_swap schedule_trigger 2>&1)" "()"

blue "\n🚩 5 example business"
test "business_example_query" "$(dfx --identity alice canister call archive_swap business_example_query 2>&1)" "\"\""
test "business_example_query" "$(dfx canister call archive_swap business_example_query 2>&1)" "\"\""
test "business_example_set" "$(dfx --identity alice canister call archive_swap business_example_set "(\"test string\")" 2>&1)" "'BusinessExampleSet' is required"
test "business_example_set" "$(dfx canister call archive_swap business_example_set "(\"test string\")" 2>&1)" "()"
...
test "business_example_cell_set" "$(dfx canister call archive_swap business_example_cell_set "(\"test string\")" 2>&1)" "()"
...
test "business_example_vec_pop" "$(dfx canister call archive_swap business_example_vec_pop "()" 2>&1)" "(null)"
test "business_example_vec_push" "$(dfx --identity alice canister call archive_swap business_example_vec_push "(5: nat64)" 2>&1)" "'BusinessExampleSet' is required"
test "business_example_vec_push" "$(dfx canister call archive_swap business_example_vec_push "(5: nat64)" 2>&1)" "()"
test "business_example_vec_query" "$(dfx --identity alice canister call archive_swap business_example_vec_query 2>&1)" "(vec { record { vec_data = 5 : nat64 } })"
test "business_example_vec_query" "$(dfx canister call archive_swap business_example_vec_query 2>&1)" "(vec { record { vec_data = 5 : nat64 } })"
test "business_example_vec_pop" "$(dfx --identity alice canister call archive_swap business_example_vec_pop "()" 2>&1)" "'BusinessExampleSet' is required"
test "business_example_vec_pop" "$(dfx canister call archive_swap business_example_vec_pop "()" 2>&1)" "(opt record { vec_data = 5 : nat64 })"
test "business_example_vec_query" "$(dfx --identity alice canister call archive_swap business_example_vec_query 2>&1)" "(vec {})"
test "business_example_vec_query" "$(dfx canister call archive_swap business_example_vec_query 2>&1)" "(vec {})"
...
test "business_example_map_update" "$(dfx canister call archive_swap business_example_map_update "(1:nat64, opt \"111\")" 2>&1)" "(null)"
test "business_example_map_query" "$(dfx --identity alice canister call archive_swap business_example_map_query 2>&1)" '(vec { record { 1 : nat64; "111" } })'
test "business_example_map_query" "$(dfx canister call archive_swap business_example_map_query 2>&1)" '(vec { record { 1 : nat64; "111" } })'
test "business_example_map_update" "$(dfx canister call archive_swap business_example_map_update "(1:nat64, opt \"123\")" 2>&1)" "(opt \"111\")"
test "business_example_map_update" "$(dfx canister call archive_swap business_example_map_update "(1:nat64, null)" 2>&1)" "(opt \"123\")"
test "business_example_map_update" "$(dfx canister call archive_swap business_example_map_update "(2:nat64, opt \"222\")" 2>&1)" "(null)"
...
test "business_example_log_update" "$(dfx canister call archive_swap business_example_log_update "(\"111\")" 2>&1)" "(0 : nat64)"
test "business_example_log_query" "$(dfx --identity alice canister call archive_swap business_example_log_query 2>&1)" '(vec { "111" })'
test "business_example_log_query" "$(dfx canister call archive_swap business_example_log_query 2>&1)" '(vec { "111" })'
test "business_example_log_update" "$(dfx canister call archive_swap business_example_log_update "(\"123\")" 2>&1)" "(1 : nat64)"
...
test "business_example_priority_queue_pop" "$(dfx canister call archive_swap business_example_priority_queue_pop "()" 2>&1)" "(null)"
test "business_example_priority_queue_push" "$(dfx --identity alice canister call archive_swap business_example_priority_queue_push "(5: nat64)" 2>&1)" "'BusinessExampleSet' is required"
test "business_example_priority_queue_push" "$(dfx canister call archive_swap business_example_priority_queue_push "(5: nat64)" 2>&1)" "()"
...
test "business_example_priority_queue_push" "$(dfx canister call archive_swap business_example_priority_queue_push "(2: nat64)" 2>&1)" "()"
test "business_example_priority_queue_query" "$(dfx canister call archive_swap business_example_priority_queue_query 2>&1)" "(vec { 2 : nat64; 5 : nat64 })"
test "business_example_priority_queue_pop" "$(dfx --identity alice canister call archive_swap business_example_priority_queue_pop "()" 2>&1)" "'BusinessExampleSet' is required"
test "business_example_priority_queue_pop" "$(dfx canister call archive_swap business_example_priority_queue_pop "()" 2>&1)" "(opt (2 : nat64))"
test "business_example_priority_queue_query" "$(dfx --identity alice canister call archive_swap business_example_priority_queue_query 2>&1)" "(vec { 5 : nat64 })"
test "business_example_priority_queue_query" "$(dfx canister call archive_swap business_example_priority_queue_query 2>&1)" "(vec { 5 : nat64 })"
