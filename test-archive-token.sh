...
test "append_blocks" "$(dfx canister call archive_token append_blocks "(vec { vec { 0:nat8 } })" 2>&1)" '()'
test "get_block_pb" "$(dfx canister call archive_token get_block_pb "(blob \"\")" 2>&1)" '(blob ' '(blob "' '(blob "a' # ! '(blob "aa' # why?
test "remaining_capacity" "$(dfx --identity alice canister call archive_token remaining_capacity 2>&1)" '(10_737_418_239 : nat64)'
test "iter_blocks_pb" "$(dfx canister call archive_token iter_blocks_pb "(blob \"\10\64\")" 2>&1)" '(blob ' '(blob "' '(blob "a' # ! '(blob "aa' # why?
