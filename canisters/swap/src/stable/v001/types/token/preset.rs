...
fn init_tokens() -> HashMap<CanisterId, TokenInfo> {
    let tokens: Vec<TokenInfo> = vec![
        // ICP Ledger
        TokenInfo::new("ryjl3-tyaaa-aaaaa-aaaba-cai", "Internet Computer", "ICP", 8, 10_000, false), // fee 0.0001 ICP
        // Cycles Ledger // https://dashboard.internetcomputer.org/canister/um5iw-rqaaa-aaaaq-qaaba-cai
        TokenInfo::new("um5iw-rqaaa-aaaaq-qaaba-cai", "Trillion Cycles", "TCYCLES", 12, 100_000_000, false), // fee 0.0001 TCycles
        // CK
        TokenInfo::new("bptq2-faaaa-aaaar-qagxq-cai", "ckWBTC",   "ckWBTC",    8,                            10, false), // fee 0.0000001 ckWBTC
        TokenInfo::new("cngnf-vqaaa-aaaar-qag4q-cai", "ckUSDT",   "ckUSDT",    6,                        10_000, false), // fee 0.01 ckUSDT
        TokenInfo::new("ebo5g-cyaaa-aaaar-qagla-cai", "ckOCT",    "ckOCT",    18,        34_000_000_000_000_000, false), // fee 0.034 ckOCT
        TokenInfo::new("etik7-oiaaa-aaaar-qagia-cai", "ckPEPE",   "ckPEPE",   18, 1_000_000_000_000_000_000_000, false), // fee 1000 ckPEPE
        TokenInfo::new("fxffn-xiaaa-aaaar-qagoa-cai", "ckSHIB",   "ckSHIB",   18,   100_000_000_000_000_000_000, false), // fee 100 ckSHIB
        TokenInfo::new("g4tto-rqaaa-aaaar-qageq-cai", "ckLINK",   "ckLINK",   18,           100_000_000_000_000, false), // fee 0.0001 ckLINK
        TokenInfo::new("ilzky-ayaaa-aaaar-qahha-cai", "ckUNI",    "ckUNI",    18,         1_000_000_000_000_000, false), // fee 0.001 ckUNI
        TokenInfo::new("j2tuh-yqaaa-aaaar-qahcq-cai", "ckWSTETH", "ckWSTETH", 18,             1_000_000_000_000, false), // fee 0.000001 ckWSTETH
        TokenInfo::new("mxzaz-hqaaa-aaaar-qaada-cai", "ckBTC",    "ckBTC",     8,                            10, false), // fee 0.0000001 ckBTC
        TokenInfo::new("nza5v-qaaaa-aaaar-qahzq-cai", "ckXAUT",   "ckXAUT",    6,                             1, false), // fee 0.000001 ckXAUT
        TokenInfo::new("pe5t5-diaaa-aaaar-qahwa-cai", "ckEURC",   "ckEURC",    6,                        10_000, false), // fee 0.01 ckEURC
        ...
        TokenInfo::new("k45jy-aiaaa-aaaaq-aadcq-cai", "Motoko",               "MOTOKO", 8,                 1_000_000, false), // fee 0.01 MOTOKO
        TokenInfo::new("kknbx-zyaaa-aaaaq-aae4a-cai", "TACO",                 "TACO",   8,                    10_000, false), // fee 0.0001 TACO
        ...
        TokenInfo::new("np5km-uyaaa-aaaaq-aadrq-cai", "Poked",                "POKED",  8,               100_000_000, false), // fee 1 POKED
