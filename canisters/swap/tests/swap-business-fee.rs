...
fn test_swap_business_fee_apis() {
    ...
    assert!(default.pair_swap_exact_tokens_for_tokens(TokenPairSwapExactTokensForTokensArgs { from: account(default_identity), amount_in: nat(100_000_000), amount_out_min: nat(100_000_000_000_000), path: vec![SwapTokenPair { token: (token_sns_icx_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_1%".to_string() }], to: account(default_identity), deadline: None, created: None, memo: None }, None).unwrap_err().reject_message.contains("INSUFFICIENT_OUTPUT_AMOUNT: 1_960_590_157"));
    assert_eq!(default.request_trace_get(9).unwrap(), None); // 👁︎
    assert_eq!(default.block_token_get(11).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.block_swap_get(6).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    ...
    assert!(default.pair_swap_tokens_for_exact_tokens(TokenPairSwapTokensForExactTokensArgs { from: account(default_identity), amount_out: nat(39_409_843), amount_in_max: nat(1_000), path: vec![SwapTokenPair { token: (token_sns_icx_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_1%".to_string() }], to: account(default_identity), deadline: None, created: None, memo: None }, None).unwrap_err().reject_message.contains("EXCESSIVE_INPUT_AMOUNT: 2_030_607"));
    assert!(default.pair_swap_tokens_for_exact_tokens(TokenPairSwapTokensForExactTokensArgs { from: account(default_identity), amount_out: nat(39_409_843), amount_in_max: nat(2_030_606), path: vec![SwapTokenPair { token: (token_sns_icx_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_1%".to_string() }], to: account(default_identity), deadline: None, created: None, memo: None }, None).unwrap_err().reject_message.contains("EXCESSIVE_INPUT_AMOUNT: 2_030_607"));
    assert_eq!(default.request_trace_get(10).unwrap(), None); // 👁︎
    ...
    assert!(default.pair_swap_by_loan(TokenPairSwapByLoanArgs { from: account(default_identity), loan: nat(2_000_000_000), path: vec![SwapTokenPair { token: (token_sns_icx_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_1%".to_string() }, SwapTokenPair { token: (token_ck_usdt_canister_id, token_ck_eth_canister_id), amm: "swap_v2_0.3%".to_string() }, SwapTokenPair { token: (token_ck_eth_canister_id, token_sns_icx_canister_id), amm: "swap_v2_0.3%".to_string() }, ], to: account(bob_identity), deadline: None, created: None, memo: None }, None).unwrap_err().reject_message.contains("INSUFFICIENT_OUTPUT_AMOUNT: 1_197_438_008"));
    assert_eq!(default.request_trace_get(13).unwrap(), None); // 👁︎
  ...
  //assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(),                                                                               vec![(token_sns_icx_canister_id, nat(             0)), (token_ck_eth_canister_id, nat(                        0)), (token_ck_usdt_canister_id, nat(              0))]);
    ...
    assert_swap_block_pair_v2_state(archive_swap.sender(default_identity).get_block(23).unwrap().unwrap(), archive_swap::SwapV2State { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id }, amm: archive_swap::Amm::SwapV2T3 }, block_timestamp: 0, supply: nat(400_000_000_216_942), reserve0: nat(894_426_326_101_196_856), reserve1: nat(178_885_611_808), price_cumulative_exponent: 64, price0_cumulative: nat(0), price1_cumulative: nat(0) }); // 👁︎
    ...
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(27).unwrap().unwrap(), archive_token::DepositToken { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }, amount: nat(216_942), to: archive_token_account(bob_identity) }); // 👁︎
    assert_token_block_withdraw(archive_token.sender(default_identity).get_block(28).unwrap().unwrap(), archive_token::DepositToken { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: archive_token_account(default_identity), amount: nat(494_427_290_999_915), to: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) } }); // 👁︎
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(29).unwrap().unwrap(), archive_token::DepositToken { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }, amount: nat(100_000_000), to: archive_token_account(alice_identity) }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(30).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_eth_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into())}, amount: nat(1_105_571_739_326_859_431), to: archive_token_account(default_identity), fee: None }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(31).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_usdt_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into())}, amount: nat(221_114_776_271), to: archive_token_account(default_identity), fee: None }); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(32).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.block_token_get(31).unwrap(), QueryTokenBlockResult::Archive(archive_token_canister_id)); // 👁︎
    assert_eq!(default.block_token_get(32).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[1].1, format!("*PairFeeMint(Deposit)* `token:[{}], from:({}.{}), to:({}.), amount:216_942`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), bob_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[2].1, format!("*PairFeeMint* `token:[{}], to:({}.), amount:216_942`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), bob_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[3].1, format!("*PairLiquidityBurn(Withdraw)* `token:[{}], from[burned liquidity]:({}.), to[withdrawn 2 tokens]:({}.{}), amount:494_427_290_999_915, fee:100_000_000`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[4].1, format!("*PairBurnFeeMint(Deposit)* `token:[{}], to:({}.), amount:100_000_000`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), alice_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[5].1, format!("*PairLiquidityBurn* `token:[{}], from:({}.), amount:494_427_190_999_915`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[6].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:1_105_571_739_326_859_431, done:1_105_571_739_326_859_431`", token_ck_eth_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(17).unwrap().unwrap().traces[7].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:221_114_776_271, done:221_114_776_271`", token_ck_usdt_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(18).unwrap(), None); // 👁︎
    assert_swap_v2_market_maker(&alice.pair_query(TokenPairPool { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id, amm: "swap_v2_0.3%".to_string() }).unwrap().unwrap(), SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "100_000_000".to_string(), decimals: 12, dummy_canister_id: token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), minimum_liquidity: "100_000_000_000".to_string(), total_supply: "400_000_000_216_942".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "894_426_326_101_196_856".to_string(), reserve1: "178_885_611_808".to_string(), subaccount: hex::encode(&token_ck_eth_token_ck_usdt_subaccount), price1_cumulative_last: "0".to_string(), token0: token_ck_eth_canister_id.to_text(), token1: token_ck_usdt_canister_id.to_text(), fee_rate: "3/1000".to_string(), k_last: "160_000_000_561_794_318_906_606_075_648".to_string(), protocol_fee: Some("1/6".to_string()), price0_cumulative_last: "0".to_string() });
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_005_571_739_326_859_431)), (token_ck_usdt_canister_id, nat(423_114_776_271)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(399_999_900_000_000))]);
    assert_tokens_balance(default.tokens_balance_of(swap::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }).unwrap(), vec![(token_ck_eth_canister_id, nat(894_426_326_101_196_856)), (token_ck_usdt_canister_id, nat(178_885_611_808)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
    assert_swap_v2_market_maker(&alice.pairs_query().unwrap()[1].1, SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "100_000".to_string(), decimals: 7, dummy_canister_id: token_sns_icx_token_ck_usdt_dummy_canister_id.to_text(), minimum_liquidity: "100_000_000".to_string(), total_supply: "44_721_359_549".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "10_302_050_607".to_string(), reserve1: "194_193_424_490".to_string(), subaccount: hex::encode(&token_sns_icx_token_ck_usdt_subaccount), price1_cumulative_last: "0".to_string(), token0: token_sns_icx_canister_id.to_text(), token1: token_ck_usdt_canister_id.to_text(), fee_rate: "1/100".to_string(), k_last: "2_000_000_000_000_000_000_000".to_string(), protocol_fee: Some("1/6".to_string()), price0_cumulative_last: "0".to_string() });
    assert_swap_v2_market_maker(&alice.pairs_query().unwrap()[2].1, SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "100_000_000".to_string(), decimals: 12, dummy_canister_id: token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), minimum_liquidity: "100_000_000_000".to_string(), total_supply: "400_000_000_216_942".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "894_426_326_101_196_856".to_string(), reserve1: "178_885_611_808".to_string(), subaccount: hex::encode(&token_ck_eth_token_ck_usdt_subaccount), price1_cumulative_last: "0".to_string(), token0: token_ck_eth_canister_id.to_text(), token1: token_ck_usdt_canister_id.to_text(), fee_rate: "3/1000".to_string(), k_last: "160_000_000_561_794_318_906_606_075_648".to_string(), protocol_fee: Some("1/6".to_string()), price0_cumulative_last: "0".to_string() });
    assert_swap_v2_market_maker(&alice.pairs_query().unwrap()[0].1, SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "1_000_000_000".to_string(), decimals: 13, dummy_canister_id: token_sns_icx_token_ck_eth_dummy_canister_id.to_text(), minimum_liquidity: "1_000_000_000_000".to_string(), total_supply: "14_142_135_623_730".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "1_999_961_426".to_string(), reserve1: "100_001_934_571_943_713".to_string(), subaccount: hex::encode(&token_sns_icx_token_ck_eth_subaccount), price1_cumulative_last: "0".to_string(), token0: token_sns_icx_canister_id.to_text(), token1: token_ck_eth_canister_id.to_text(), fee_rate: "3/1000".to_string(), k_last: "200_000_000_000_000_000_000_000_000".to_string(), protocol_fee: Some("1/6".to_string()), price0_cumulative_last: "0".to_string() });
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_ck_eth_token_ck_usdt_dummy_canister_id, nat(399_999_900_000_000)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(44_721_359_549)), (token_sns_icx_token_ck_eth_dummy_canister_id, nat(14_142_135_623_730))]);
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_token_ck_usdt_dummy_canister_id, nat(        100_000_000)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(             0)), (token_sns_icx_token_ck_eth_dummy_canister_id, nat(                 0))]);
    assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(), vec![(token_ck_eth_token_ck_usdt_dummy_canister_id, nat(            216_942)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(             0)), (token_sns_icx_token_ck_eth_dummy_canister_id, nat(                 0))]);

    // 🚩 2.8 business pair liquidity transfer
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_ck_eth_token_ck_usdt_dummy_canister_id, nat(399_999_900_000_000))]);
    ...
    assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(), vec![(token_ck_eth_token_ck_usdt_dummy_canister_id, nat(100_000_000_216_942))]);
    ...
    assert_token_block_chain_view(&default.config_token_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_token_canister_id, length: 33, max_length: 100_000_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: Some(vec![default_identity]), max_memory_size_bytes: None, max_length: 100_000_000 }, next_block_index: 33, archived: vec![] });
    ...
    assert_token_current_archiving_max_length(default.config_token_block_chain_update(BlockChainArgs::CurrentArchivingMaxLengthUpdate(1000)).unwrap(), CurrentArchiving { canister_id: archive_token_canister_id, length: 33, max_length: 1_000, block_height_offset: 0 });
    assert_token_block_chain_view(&default.config_token_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_token_canister_id, length: 33, max_length: 1_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: Some(vec![default_identity]), max_memory_size_bytes: None, max_length: 1_000 }, next_block_index: 33, archived: vec![] });
    ...
    assert_token_get_blocks(archive_token.sender(alice_identity).get_blocks(archive_token::GetBlocksArgs{ start: 0, length: 100 }).unwrap(), 33);

    // 🚩 5 test archive-swap
    assert_swap_block_chain_view(&default.config_swap_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_swap_canister_id, length: 25, max_length: 100_000_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: None, max_memory_size_bytes: None, max_length: 100_000_000 }, next_block_index: 25, archived: vec![] });
    ...
    assert_swap_current_archiving_max_length(default.config_swap_block_chain_update(BlockChainArgs::CurrentArchivingMaxLengthUpdate(1000)).unwrap(), CurrentArchiving { canister_id: archive_swap_canister_id, length: 25, max_length: 1_000, block_height_offset: 0 });
    assert_swap_block_chain_view(&default.config_swap_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_swap_canister_id, length: 25, max_length: 1_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: None, max_memory_size_bytes: None, max_length: 1_000 }, next_block_index: 25, archived: vec![] });
    ...
    assert_swap_get_blocks(archive_swap.sender(bob_identity).get_blocks(archive_swap::GetBlocksArgs{ start: 0, length: 100 }).unwrap(), 25);
