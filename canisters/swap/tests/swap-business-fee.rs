...
#[test]
#[rustfmt::skip]
fn test_swap_business_fee_apis() {
    ...
    assert_eq!(default.request_trace_get(6).unwrap(), None); // 👁︎
    assert_eq!(default.block_token_get(7).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.block_token_get(8).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.block_token_get(9).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(7).unwrap(), None); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(8).unwrap(), None); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(9).unwrap(), None); // 👁︎
    assert_eq!(default.block_swap_get(3).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(archive_swap.sender(default_identity).get_block(3).unwrap(), None); // 👁︎
    assert_eq!(default.pair_liquidity_remove(TokenPairLiquidityRemoveArgs { swap_pair: SwapTokenPair { token: (token_ck_eth_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_0.3%".to_string() }, from: account(default_identity), to: account(default_identity), liquidity_without_fee: nat(447_213_595_499_958), amount_min: (nat(1), nat(1)), deadline:None, created: None, memo: None}, None).unwrap(), TokenPairLiquidityRemoveResult::Ok(TokenPairLiquidityRemoveSuccess { amount: (nat(1_000_000_000_000_001_118), nat(200_000_000_000)) }));
    std::thread::sleep(std::time::Duration::from_secs(2)); // 🕰︎
    archive_swap.sender(canister_id).append_blocks(vec![]).unwrap(); // ! BUG
    assert_swap_block_pair_v2_burn(archive_swap.sender(default_identity).get_block(3).unwrap().unwrap(), archive_swap::SwapV2BurnToken { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id }, amm: archive_swap::Amm::SwapV2T3 }, from: archive_swap_account(default_identity), to: archive_swap_account(default_identity), token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id, amount0: nat(1_000_000_000_000_001_118), amount1: nat(200_000_000_000), token: token_ck_eth_token_ck_usdt_dummy_canister_id, amount: nat(447_213_595_499_958), fee: None }); // 👁︎
    assert_swap_block_pair_v2_state(archive_swap.sender(default_identity).get_block(4).unwrap().unwrap(), archive_swap::SwapV2State { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id }, amm: archive_swap::Amm::SwapV2T3 }, block_timestamp: 0, supply: nat(447_213_595_499_957), reserve0: nat(999_999_999_999_998_882), reserve1: nat(200_000_000_000), price_cumulative_exponent: 64, price0_cumulative: nat(0), price1_cumulative: nat(0) }); // 👁︎
    assert_eq!(archive_swap.sender(default_identity).get_block(5).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.block_swap_get(5).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_token_block_withdraw(archive_token.sender(default_identity).get_block(7).unwrap().unwrap(), archive_token::DepositToken { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: archive_token_account(default_identity), amount: nat(447_213_595_499_958), to: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) } }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(8).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_eth_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into())}, amount: nat(1_000_000_000_000_001_118), to: archive_token_account(default_identity), fee: None }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(9).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_usdt_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into())}, amount: nat(200_000_000_000), to: archive_token_account(default_identity), fee: None }); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(10).unwrap(), None); // 👁︎
    ...
    assert_eq!(archive_token.sender(default_identity).get_block(10).unwrap(), None); // 👁︎
    assert_eq!(default.request_trace_get(6).unwrap().unwrap().traces[1].1, format!("*PairLiquidityBurn(Withdraw)*. `token:[{}], from[burned liquidity]:({}.), to[withdrawn 2 tokens]:({}.{}), amount:447_213_595_499_958, fee:None`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(6).unwrap().unwrap().traces[2].1, format!("*PairLiquidityBurn* `token:[{}], from:({}.), amount:447_213_595_499_958`", token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(6).unwrap().unwrap().traces[3].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:1_000_000_000_000_001_118, done:1_000_000_000_000_001_118`", token_ck_eth_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(6).unwrap().unwrap().traces[4].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:200_000_000_000, done:200_000_000_000`", token_ck_usdt_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(7).unwrap(), None); // 👁︎
    assert_swap_v2_market_maker(&alice.pair_query(TokenPairPool { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id, amm: "swap_v2_0.3%".to_string() }).unwrap().unwrap(), SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "100_000_000".to_string(), decimals: 12, dummy_canister_id: token_ck_eth_token_ck_usdt_dummy_canister_id.to_text(), minimum_liquidity: "100_000_000_000".to_string(), total_supply: "447_213_595_499_957".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "999_999_999_999_998_882".to_string(), reserve1: "200_000_000_000".to_string(), subaccount: hex::encode(&token_ck_eth_token_ck_usdt_subaccount), price1_cumulative_last: "0".to_string(), token0: token_ck_eth_canister_id.to_text(), token1: token_ck_usdt_canister_id.to_text(), fee_rate: "3/1000".to_string(), k_last: "0".to_string(), protocol_fee: None, price0_cumulative_last: "0".to_string() });
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000_001_118)), (token_ck_usdt_canister_id, nat(600_000_000_000)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(447_213_595_499_957))]);
    assert_tokens_balance(default.tokens_balance_of(swap::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }).unwrap(), vec![(token_ck_eth_canister_id, nat(999_999_999_999_998_882)), (token_ck_usdt_canister_id, nat(200_000_000_000)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
    ...
    assert_swap_block_pair_create(archive_swap.sender(default_identity).get_block(5).unwrap().unwrap(), archive_swap::PairCreate { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_sns_icx_canister_id, token1: token_ck_usdt_canister_id  }, amm: archive_swap::Amm::SwapV2H1 }, creator: default_identity  }); // 👁︎
    assert_eq!(default.block_swap_get(5).unwrap(), QuerySwapBlockResult::Archive(archive_swap_canister_id)); // 👁︎
    assert_eq!(default.request_trace_get(7).unwrap().unwrap().traces[0].1, format!("*TokenPairCreate* `token0:[{}], token1:[{}], amm:swap_v2_1%, subaccount:({}), dummyCanisterId:[{}]`", token_sns_icx_canister_id.to_text(), token_ck_usdt_canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount), token_sns_icx_token_ck_usdt_dummy_canister_id.to_text())); // 👁︎
    ...
    std::thread::sleep(std::time::Duration::from_secs(2)); // 🕰︎
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(10).unwrap().unwrap(), archive_token::DepositToken { token: token_sns_icx_canister_id, from: archive_token_account(default_identity), amount: nat(20_000_000_000), to: archive_token_account(default_identity) }); // 👁︎
    assert_eq!(default.block_token_get(10).unwrap(), QueryTokenBlockResult::Archive(archive_token_canister_id)); // 👁︎
    assert_eq!(default.request_trace_get(8).unwrap().unwrap().traces[0].1, format!("*Deposit* `token:[{}], from:({}.), to:({}.), amount:20_000_000_000, height:2`", token_sns_icx_canister_id.to_text(), default_identity.to_text(), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap(), None); // 👁︎
    assert_eq!(default.pair_swap_exact_tokens_for_tokens(TokenPairSwapExactTokensForTokensArgs { from: account(default_identity), amount_in: nat(100_000_000), amount_out_min: nat(100_000_000_000_000), path: vec![SwapTokenPair { token: (token_sns_icx_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_1%".to_string() }], to: account(default_identity), deadline: None, created: None, memo: None }, None).unwrap(), TokenPairSwapTokensResult::Err(BusinessError::Swap("INSUFFICIENT_LIQUIDITY".to_string())));
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(20_000_000_000)), (token_ck_usdt_canister_id, nat(600_000_000_000)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(0))]);
    ...
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(13).unwrap().unwrap(), archive_token::DepositToken { token: token_sns_icx_token_ck_usdt_dummy_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_usdt_subaccount.clone().into()) }, amount: nat(44_721_359_549), to: archive_token_account(default_identity) }); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(14).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.block_token_get(14).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap().unwrap().traces[1].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:10_000_000_000, done:10_000_000_000`", token_sns_icx_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap().unwrap().traces[2].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:200_000_000_000, done:200_000_000_000`", token_ck_usdt_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap().unwrap().traces[3].1, format!("*PairLiquidityAdd* `amount_a:10_000_000_000, amount_b:200_000_000_000`{}", "")); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap().unwrap().traces[4].1, format!("*PairLiquidityMint(Deposit)* `token:[{}], from[transferred 2 tokens]:({}.{}), to[minted liquidity]:({}.), amount:44_721_359_549`", token_sns_icx_token_ck_usdt_dummy_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(9).unwrap().unwrap().traces[5].1, format!("*PairLiquidityMint* `token:[{}], to:({}.), amount:44_721_359_549`", token_sns_icx_token_ck_usdt_dummy_canister_id.to_text(), default_identity.to_text())); // 👁︎
    ...
    assert_swap_v2_market_maker(&alice.pair_query(TokenPairPool { token0: token_sns_icx_canister_id, token1: token_ck_usdt_canister_id, amm: "swap_v2_1%".to_string() }).unwrap().unwrap(), SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "100_000".to_string(), decimals: 7, dummy_canister_id: token_sns_icx_token_ck_usdt_dummy_canister_id.to_text(), minimum_liquidity: "100_000_000".to_string(), total_supply: "44_721_359_549".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "10_000_000_000".to_string(), reserve1: "200_000_000_000".to_string(), subaccount: hex::encode(&token_sns_icx_token_ck_usdt_subaccount), price1_cumulative_last: "0".to_string(), token0: token_sns_icx_canister_id.to_text(), token1: token_ck_usdt_canister_id.to_text(), fee_rate: "1/100".to_string(), k_last: "0".to_string(), protocol_fee: None, price0_cumulative_last: "0".to_string() });
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(10_000_000_000)), (token_ck_usdt_canister_id, nat(400_000_000_000)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(44_721_359_549))]);
    ...
    std::thread::sleep(std::time::Duration::from_secs(2)); // 🕰︎
    archive_swap.sender(canister_id).append_blocks(vec![]).unwrap(); // ! BUG
    assert_swap_block_pair_swap(archive_swap.sender(default_identity).get_block(8).unwrap().unwrap(), archive_swap::PairSwapToken { token_a: token_sns_icx_canister_id, token_b: token_ck_usdt_canister_id, amm: archive_swap::Amm::SwapV2H1, from: archive_swap_account(default_identity), to: archive_swap_account(default_identity), amount_a: nat(100_000_000), amount_b: nat(1_960_590_157) }); // 👁︎
    ...
    assert_eq!(archive_token.sender(default_identity).get_block(16).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.request_trace_get(10).unwrap().unwrap().traces[0].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:100_000_000, done:100_000_000`", token_sns_icx_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(10).unwrap().unwrap().traces[1].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:1_960_590_157, done:1_960_590_157`", token_ck_usdt_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(10).unwrap().unwrap().traces[2].1, format!("*TokenPairSwap* `swap_pair:([{}],[{}],swap_v2_1%), from:({}.), to:({}.), pay_amount:100_000_000, got_amount:1_960_590_157`", token_sns_icx_canister_id.to_text(), token_ck_usdt_canister_id.to_text(), default_identity.to_text(), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(11).unwrap(), None); // 👁︎
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(9_900_000_000)), (token_ck_usdt_canister_id, nat(401_960_590_157)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(44_721_359_549))]);
    ...
    assert_eq!(default.request_trace_get(12).unwrap(), None); // 👁︎
    assert_eq!(default.block_token_get(16).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.block_swap_get(10).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    ...
    std::thread::sleep(std::time::Duration::from_secs(2)); // 🕰︎
    archive_swap.sender(canister_id).append_blocks(vec![]).unwrap(); // ! BUG
    assert_swap_block_pair_swap(archive_swap.sender(default_identity).get_block(10).unwrap().unwrap(), archive_swap::PairSwapToken { token_a: token_sns_icx_canister_id, token_b: token_ck_usdt_canister_id, amm: archive_swap::Amm::SwapV2H1, from: archive_swap_account(default_identity), to: archive_swap_account(default_identity), amount_a: nat(2_030_607), amount_b: nat(39_409_843) }); // 👁︎
    assert_swap_block_pair_v2_state(archive_swap.sender(default_identity).get_block(11).unwrap().unwrap(), archive_swap::SwapV2State { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_sns_icx_canister_id, token1: token_ck_usdt_canister_id }, amm: archive_swap::Amm::SwapV2H1 }, block_timestamp: 0, supply: nat(44_721_359_549), reserve0: nat(10_102_030_607), reserve1: nat(198_000_000_000), price_cumulative_exponent: 64, price0_cumulative: nat(0), price1_cumulative: nat(0) }); // 👁︎
    assert_eq!(archive_swap.sender(default_identity).get_block(12).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.block_swap_get(12).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    ...
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(17).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_usdt_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_usdt_subaccount.clone().into()) }, amount: nat(39_409_843), to: archive_token_account(default_identity), fee: None }); // 👁︎
    ...
    assert_eq!(default.request_trace_get(11).unwrap().unwrap().traces[0].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:2_030_607, done:2_030_607`", token_sns_icx_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(11).unwrap().unwrap().traces[1].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:39_409_843, done:39_409_843`", token_ck_usdt_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(11).unwrap().unwrap().traces[2].1, format!("*TokenPairSwap* `swap_pair:([{}],[{}],swap_v2_1%), from:({}.), to:({}.), pay_amount:2_030_607, got_amount:39_409_843`", token_sns_icx_canister_id.to_text(), token_ck_usdt_canister_id.to_text(), default_identity.to_text(), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(12).unwrap(), None); // 👁︎
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(9_897_969_393)), (token_ck_usdt_canister_id, nat(402_000_000_000)), (token_sns_icx_token_ck_usdt_dummy_canister_id, nat(44_721_359_549))]);
    ...
    assert_swap_block_pair_create(archive_swap.sender(default_identity).get_block(12).unwrap().unwrap(), archive_swap::PairCreate { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_sns_icx_canister_id, token1: token_ck_eth_canister_id  }, amm: archive_swap::Amm::SwapV2T3 }, creator: default_identity  }); // 👁︎
    assert_eq!(default.block_swap_get(12).unwrap(), QuerySwapBlockResult::Archive(archive_swap_canister_id)); // 👁︎
    assert_eq!(default.request_trace_get(12).unwrap().unwrap().traces[0].1, format!("*TokenPairCreate* `token0:[{}], token1:[{}], amm:swap_v2_0.3%, subaccount:({}), dummyCanisterId:[{}]`", token_sns_icx_canister_id.to_text(), token_ck_eth_canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount), token_sns_icx_token_ck_eth_dummy_canister_id.to_text())); // 👁︎
    ...
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(9_897_969_393)), (token_ck_eth_canister_id, nat(2_000_000_000_000_001_118)), (token_sns_icx_token_ck_eth_dummy_canister_id, nat(0))]);
    ...
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(20).unwrap().unwrap(), archive_token::DepositToken { token: token_sns_icx_token_ck_eth_dummy_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_eth_subaccount.clone().into()) }, amount: nat(14_142_135_623_730), to: archive_token_account(default_identity) }); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(21).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.request_trace_get(13).unwrap().unwrap().traces[1].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:2_000_000_000, done:2_000_000_000`", token_sns_icx_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(13).unwrap().unwrap().traces[2].1, format!("*TokenTransfer* `token:[{}], from:({}.), to:({}.{}), amount:100_000_000_000_000_000, done:100_000_000_000_000_000`", token_ck_eth_canister_id.to_text(), default_identity.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(13).unwrap().unwrap().traces[3].1, format!("*PairLiquidityAdd* `amount_a:2_000_000_000, amount_b:100_000_000_000_000_000`{}", "")); // 👁︎
    assert_eq!(default.request_trace_get(13).unwrap().unwrap().traces[4].1, format!("*PairLiquidityMint(Deposit)* `token:[{}], from[transferred 2 tokens]:({}.{}), to[minted liquidity]:({}.), amount:14_142_135_623_730`", token_sns_icx_token_ck_eth_dummy_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount), default_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(13).unwrap().unwrap().traces[5].1, format!("*PairLiquidityMint* `token:[{}], to:({}.), amount:14_142_135_623_730`", token_sns_icx_token_ck_eth_dummy_canister_id.to_text(), default_identity.to_text())); // 👁︎
    ...
    assert_swap_v2_market_maker(&alice.pair_query(TokenPairPool { token0: token_sns_icx_canister_id, token1: token_ck_eth_canister_id, amm: "swap_v2_0.3%".to_string() }).unwrap().unwrap(), SwapV2MarketMakerView { lp: PoolLpView::Inner(InnerLpView { fee: "1_000_000_000".to_string(), decimals: 13, dummy_canister_id: token_sns_icx_token_ck_eth_dummy_canister_id.to_text(), minimum_liquidity: "1_000_000_000_000".to_string(), total_supply: "14_142_135_623_730".to_string() }), price_cumulative_exponent: 64, block_timestamp_last: 0, reserve0: "2_000_000_000".to_string(), reserve1: "100_000_000_000_000_000".to_string(), subaccount: hex::encode(&token_sns_icx_token_ck_eth_subaccount), price1_cumulative_last: "0".to_string(), token0: token_sns_icx_canister_id.to_text(), token1: token_ck_eth_canister_id.to_text(), fee_rate: "3/1000".to_string(), k_last: "0".to_string(), protocol_fee: None, price0_cumulative_last: "0".to_string() });
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_sns_icx_canister_id, nat(7_897_969_393)), (token_ck_eth_canister_id, nat(1_900_000_000_000_001_118)), (token_sns_icx_token_ck_eth_dummy_canister_id, nat(14_142_135_623_730))]);
    ...
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(),                                                                               vec![(token_sns_icx_canister_id, nat( 7_897_969_393)), (token_ck_eth_canister_id, nat(1_900_000_000_000_001_118)), (token_ck_usdt_canister_id, nat(402_000_000_000))]);
    ...
    assert_tokens_balance(default.tokens_balance_by(Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }).unwrap(),  vec![(token_sns_icx_canister_id, nat(             0)), (token_ck_eth_canister_id, nat(  999_999_999_999_998_882)), (token_ck_usdt_canister_id, nat(200_000_000_000))]);
    ...
    assert_swap_block_pair_swap(archive_swap.sender(default_identity).get_block(17).unwrap().unwrap(), archive_swap::PairSwapToken { token_a: token_ck_usdt_canister_id, token_b: token_ck_eth_canister_id, amm: archive_swap::Amm::SwapV2T3, from: archive_swap::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }, to: archive_swap::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_eth_subaccount.clone().into()) }, amount_a: nat(388_079), amount_b: nat(1_934_570_072_431) }); // 👁︎
    assert_swap_block_pair_v2_state(archive_swap.sender(default_identity).get_block(18).unwrap().unwrap(), archive_swap::SwapV2State { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_ck_eth_canister_id, token1: token_ck_usdt_canister_id }, amm: archive_swap::Amm::SwapV2T3 }, block_timestamp: 0, supply: nat(447_213_595_499_957), reserve0: nat(999_998_065_429_926_451), reserve1: nat(200_000_388_079), price_cumulative_exponent: 64, price0_cumulative: nat(0), price1_cumulative: nat(0) }); // 👁︎
    assert_swap_block_pair_swap(archive_swap.sender(default_identity).get_block(19).unwrap().unwrap(), archive_swap::PairSwapToken { token_a: token_ck_eth_canister_id, token_b: token_sns_icx_canister_id, amm: archive_swap::Amm::SwapV2T3, from: archive_swap::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_eth_subaccount.clone().into()) }, to: archive_swap_account(bob_identity), amount_a: nat(1_934_570_072_431), amount_b: nat(38_574) }); // 👁︎
    assert_swap_block_pair_v2_state(archive_swap.sender(default_identity).get_block(20).unwrap().unwrap(), archive_swap::SwapV2State { pa: archive_swap::TokenPairAmm { pair: archive_swap::TokenPair { token0: token_sns_icx_canister_id, token1: token_ck_eth_canister_id }, amm: archive_swap::Amm::SwapV2T3 }, block_timestamp: 0, supply: nat(14_142_135_623_730), reserve0: nat(1_999_961_426), reserve1: nat(100_001_934_570_072_431), price_cumulative_exponent: 64, price0_cumulative: nat(0), price1_cumulative: nat(0) }); // 👁︎
    ...
    assert_token_block_deposit(archive_token.sender(default_identity).get_block(21).unwrap().unwrap(), archive_token::DepositToken { token: token_sns_icx_canister_id, from: archive_token_account(canister_id), amount: nat(20_000), to: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_usdt_subaccount.clone().into()) } }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(22).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_usdt_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_usdt_subaccount.clone().into()) }, amount: nat(388_079), to: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }, fee: None }); // 👁︎
    assert_token_block_transfer(archive_token.sender(default_identity).get_block(23).unwrap().unwrap(), archive_token::TransferToken { token: token_ck_eth_canister_id, from: archive_token::Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }, amount: nat(1_934_570_072_431), to: archive_token::Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_eth_subaccount.clone().into()) }, fee: None }); // 👁︎
    ...
    assert_token_block_withdraw(archive_token.sender(default_identity).get_block(25).unwrap().unwrap(), archive_token::DepositToken { token: token_sns_icx_canister_id, from: archive_token_account(bob_identity), amount: nat(20_000), to: archive_token_account(canister_id) }); // 👁︎
    assert_eq!(archive_token.sender(default_identity).get_block(26).unwrap(), None); // 👁︎
    ...
    assert_eq!(default.block_token_get(26).unwrap_err().reject_message.contains("invalid block height"), true); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[0].1, format!("*TokenLoan* `token:[{}], from:({}.), to:({}.{}), amount:20_000`", token_sns_icx_canister_id.to_text(), canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[1].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.{}), amount:388_079, done:388_079`", token_ck_usdt_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_usdt_subaccount), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[2].1, format!("*TokenPairSwap* `swap_pair:([{}],[{}],swap_v2_1%), from:({}.), to:({}.{}), pay_amount:20_000, got_amount:388_079`", token_sns_icx_canister_id.to_text(), token_ck_usdt_canister_id.to_text(), canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[4].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.{}), amount:1_934_570_072_431, done:1_934_570_072_431`", token_ck_eth_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[5].1, format!("*TokenPairSwap* `swap_pair:([{}],[{}],swap_v2_0.3%), from:({}.{}), to:({}.{}), pay_amount:388_079, got_amount:1_934_570_072_431`", token_ck_usdt_canister_id.to_text(), token_ck_eth_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_ck_eth_token_ck_usdt_subaccount), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount))); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[7].1, format!("*TokenTransfer* `token:[{}], from:({}.{}), to:({}.), amount:38_574, done:38_574`", token_sns_icx_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount), bob_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[8].1, format!("*TokenPairSwap* `swap_pair:([{}],[{}],swap_v2_0.3%), from:({}.{}), to:({}.), pay_amount:1_934_570_072_431, got_amount:38_574`", token_ck_eth_canister_id.to_text(), token_sns_icx_canister_id.to_text(), canister_id.to_text(), hex::encode(&token_sns_icx_token_ck_eth_subaccount), bob_identity.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(14).unwrap().unwrap().traces[10].1, format!("*TokenRepay* `token:[{}], from:({}.), to:({}.), amount:20_000`", token_sns_icx_canister_id.to_text(), bob_identity.to_text(), canister_id.to_text())); // 👁︎
    assert_eq!(default.request_trace_get(15).unwrap(), None); // 👁︎
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(),                                                                               vec![(token_sns_icx_canister_id, nat( 7_897_969_393)), (token_ck_eth_canister_id, nat(1_900_000_000_000_001_118)), (token_ck_usdt_canister_id, nat(402_000_000_000))]);
  //assert_tokens_balance(default.tokens_balance_by(Account { owner: canister_id, subaccount: Some(token_sns_icx_token_ck_usdt_subaccount.clone().into()) }).unwrap(), vec![(token_sns_icx_canister_id, nat(10_102_030_607)), (token_ck_eth_canister_id, nat(                        0)), (token_ck_usdt_canister_id, nat(198_000_000_000))]);
  ...
  //assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(),                                                                               vec![(token_sns_icx_canister_id, nat(             0)), (token_ck_eth_canister_id, nat(                        0)), (token_ck_usdt_canister_id, nat(              0))]);
    ...
    std::thread::sleep(std::time::Duration::from_secs(2)); // 🕰︎
    archive_swap.sender(canister_id).append_blocks(vec![]).unwrap(); // ! BUG
    assert_swap_block_pair_swap(archive_swap.sender(default_identity).get_block(21).unwrap().unwrap(), archive_swap::PairSwapToken { token_a: token_sns_icx_canister_id, token_b: token_ck_usdt_canister_id, amm: archive_swap::Amm::SwapV2H1, from: archive_swap_account(default_identity), to: archive_swap_account(default_identity), amount_a: nat(200_000_000), amount_b: nat(3_806_187_431) }); // 👁︎
    ...
    assert_token_block_chain_view(&default.config_token_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_token_canister_id, length: 30, max_length: 1_000_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: Some(vec![default_identity]), max_memory_size_bytes: None, max_length: 1_000_000 }, next_block_index: 30, archived: vec![] });
    ...
    assert_token_current_archiving_max_length(default.config_token_block_chain_update(BlockChainArgs::CurrentArchivingMaxLengthUpdate(1000)).unwrap(), CurrentArchiving { canister_id: archive_token_canister_id, length: 30, max_length: 1_000, block_height_offset: 0 });
    assert_token_block_chain_view(&default.config_token_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_token_canister_id, length: 30, max_length: 1_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: Some(vec![default_identity]), max_memory_size_bytes: None, max_length: 1_000 }, next_block_index: 30, archived: vec![] });
    ...
    assert_token_get_blocks(archive_token.sender(alice_identity).get_blocks(archive_token::GetBlocksArgs{ start: 0, length: 100 }).unwrap(), 30);

    // 🚩 5 test archive-swap
    assert_swap_block_chain_view(&default.config_swap_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_swap_canister_id, length: 23, max_length: 1_000_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: None, max_memory_size_bytes: None, max_length: 1_000_000 }, next_block_index: 23, archived: vec![] });
    ...
    assert_swap_current_archiving_max_length(default.config_swap_block_chain_update(BlockChainArgs::CurrentArchivingMaxLengthUpdate(1000)).unwrap(), CurrentArchiving { canister_id: archive_swap_canister_id, length: 23, max_length: 1_000, block_height_offset: 0 });
    assert_swap_block_chain_view(&default.config_swap_block_chain_query(BlockChainArgs::BlockChainQuery).unwrap(), BlockChainView { current_archiving: Some(CurrentArchiving { canister_id: archive_swap_canister_id, length: 23, max_length: 1_000, block_height_offset: 0 }), latest_block_hash: vec![].into(), archive_config: NextArchiveCanisterConfig { maintainers: None, max_memory_size_bytes: None, max_length: 1_000 }, next_block_index: 23, archived: vec![] });
    ...
    assert_swap_get_blocks(archive_swap.sender(bob_identity).get_blocks(archive_swap::GetBlocksArgs{ start: 0, length: 100 }).unwrap(), 23);
    ...
    assert_eq!(default.request_trace_index_get().unwrap(), (0, 18));
