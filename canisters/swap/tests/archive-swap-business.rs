...
fn test_archive_swap_business_apis() {
    ...
    assert_eq!(alice.remaining_capacity().unwrap(), 10_737_418_148);
...
"##.as_bytes().to_vec().into(), headers: vec![("Content-Type".to_string(), "text/plain".to_string())], upgrade: None, streaming_strategy: None, status_code: 200 });
    ...
    assert_eq!(alice.query_metrics().unwrap(), CustomMetrics { stable_memory_pages: 257, stable_memory_bytes: 16_842_752, heap_memory_bytes: 1_245_184, last_upgrade_time_seconds: 0, max_memory_size_bytes: 10_737_418_240, blocks: 1, blocks_bytes: 92, block_height_offset: 0 });

    // 🚩 4 business set_max_memory_size_bytes
    assert_eq!(default.query_metrics().unwrap(), CustomMetrics { stable_memory_pages: 257, stable_memory_bytes: 16_842_752, heap_memory_bytes: 1_245_184, last_upgrade_time_seconds: 0, max_memory_size_bytes: 10_737_418_240, blocks: 1, blocks_bytes: 92, block_height_offset: 0 });
