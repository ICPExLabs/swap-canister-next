...
if [ ! -f "canisters/archive-token/sources/source_opt.wasm" ]; then
...
if [ ! -f "canisters/archive-swap/sources/source_opt.wasm" ]; then
...
if [ ! -f "canisters/swap/sources/source_opt.wasm" ]; then
