...
#[test]
#[rustfmt::skip]
fn test_swap_business_to_fee_apis() {
    ...
    assert_eq!(alice.token_transfer(TokenTransferArgs { token: token_ck_eth_canister_id, from: account(alice_identity), transfer_amount_without_fee: nat(2_000_000_000_000_000_000), to: account(default_identity), fee: None, created: None, memo: None }, None).unwrap(), TokenChangedResult::Ok(nat(2_000_002_000_000_000_000)));
    pic.tick(); // 🕰︎
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000))]);
    ...
    assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000))]);
    ...
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);

    // 🚩 1.5 transfer liquidity
    assert_eq!(default.token_transfer(TokenTransferArgs { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: account(default_identity), transfer_amount_without_fee: nat(894_427_090_999_915), to: account(alice_identity), fee: None, created: None, memo: None }, None).unwrap(), TokenChangedResult::Ok(nat(894_427_190_999_915)));
    assert_tokens_balance(  bob.tokens_balance_of(account(  bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(100_000_000))]);
    pic.tick(); // 🕰︎
    ...
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(894_427_090_999_915))]);
    assert_tokens_balance(  bob.tokens_balance_of(account(  bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(100_000_000))]);
    ...
    assert_eq!(alice.pair_liquidity_remove(TokenPairLiquidityRemoveArgs { swap_pair: SwapTokenPair { token: (token_ck_eth_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_0.3%".to_string() }, from: account(alice_identity), to: account(default_identity), liquidity_without_fee: nat(894_327_190_999_915), amount_min: (nat(1), nat(1)), deadline:None, created: None, memo: None}, None).unwrap(), TokenPairLiquidityRemoveResult::Ok(TokenPairLiquidityRemoveSuccess { amount: (nat(1_999_776_393_202_250_020), nat(399_955_278_640)) }));
    pic.tick(); // 🕰︎
    assert_tokens_balance(default.tokens_balance_of(account(default_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_776_393_202_250_020)), (token_ck_usdt_canister_id, nat(799_955_278_640)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(99_800_000_000))]);
    assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(200_000_000))]);
    assert_tokens_balance(alice.tokens_balance_of(Account { owner: canister_id, subaccount: Some(token_ck_eth_token_ck_usdt_subaccount.clone().into()) }).unwrap(), vec![(token_ck_eth_canister_id, nat(223_606_797_749_980)), (token_ck_usdt_canister_id, nat(44_721_360))]);

    // 🚩 1.7 clean liquidity
    assert_eq!(alice.token_transfer(TokenTransferArgs { token: token_ck_eth_token_ck_usdt_dummy_canister_id, from: account(alice_identity), transfer_amount_without_fee: nat(99_800_000_000), to: account(bob_identity), fee: None, created: None, memo: None }, None).unwrap(), TokenChangedResult::Ok(nat(99_800_000_000)));
    assert_tokens_balance(  bob.tokens_balance_of(account(  bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(100_000_000_000))]);
    pic.tick(); // 🕰︎
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
    assert_eq!(bob.pair_liquidity_remove(TokenPairLiquidityRemoveArgs { swap_pair: SwapTokenPair { token: (token_ck_eth_canister_id, token_ck_usdt_canister_id), amm: "swap_v2_0.3%".to_string() }, from: account(bob_identity), to: account(default_identity), liquidity_without_fee: nat(100_000_000_000), amount_min: (nat(1), nat(1)), deadline:None, created: None, memo: None}, None).unwrap(), TokenPairLiquidityRemoveResult::Ok(TokenPairLiquidityRemoveSuccess { amount: (nat(223_606_797_749_980), nat(44_721_360)) }));
    pic.tick(); // 🕰︎
    ...
    assert_tokens_balance(  alice.tokens_balance_of(account(  alice_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(1_999_998_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
    assert_tokens_balance(    bob.tokens_balance_of(account(    bob_identity)).unwrap(), vec![(token_ck_eth_canister_id, nat(2_000_000_000_000)), (token_ck_usdt_canister_id, nat(0)), (token_ck_eth_token_ck_usdt_dummy_canister_id, nat(0))]);
