...
fn init_tokens() -> HashMap<CanisterId, TokenInfo> {
    let tokens: Vec<TokenInfo> = vec![
        ...
        TokenInfo::new("um5iw-rqaaa-aaaaq-qaaba-cai", "Trillion Cycles", "TCYCLES", 12, 100_000_000), // fee 0.0001 TCycles
        // CK
        ...
        TokenInfo::new("lrtnw-paaaa-aaaaq-aadfa-cai", "SWAMPDAO",             "SWAMP",  8,                    10_000), // fee 0.0001 SWAMP
        ...
        TokenInfo::new("rffwt-piaaa-aaaaq-aabqq-cai", "Seers",                "SEER",   8,               100_000_000), // fee 1 SEER
