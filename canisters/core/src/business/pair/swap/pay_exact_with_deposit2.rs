...
async fn pair_swap_with_deposit_and_withdraw2(
    ...
    ic_cdk::println!("pair_swap_with_deposit_and_withdraw2 #0: {:?}", args);
    ...
    ic_cdk::println!("pair_swap_with_deposit_and_withdraw2 #1: {:?}", deposit);
    ...
    ic_cdk::println!(
        "pair_swap_with_deposit_and_withdraw2 #2: {:?} {:?}",
        deposit_result,
        swap
    );
    ...
    ic_cdk::println!(
        "pair_swap_with_deposit_and_withdraw2 #3: {:?} {:?}",
        swap_result,
        withdraw
    );
