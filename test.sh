...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" 2>&1)" '(null)'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(12:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(6:nat64)" --output json 2>&1)" 'invalid block height'
start_time_s0=$(date +%s)
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(6:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(7:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(12:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(13:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(14:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" 2>&1)" '(null)'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" 2>&1)" '(null)'
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(7:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(8:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(9:nat64)" --output json 2>&1)" 'invalid block height'
...
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(14:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(15:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(16:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(17:nat64)" --output json 2>&1)" 'invalid block height'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(13:nat64)" 2>&1)" '(null)'
