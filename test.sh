...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(2:nat64)" 2>&1)" '( opt record { args = variant { token_transfer = record { arg = record { to = record { owner = principal "'"$ALICE"'"; subaccount = null; }; fee = null; token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; from = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; amount = 1_000_000_000_000_000_000 : nat; }; now = ' ' : nat64; created = null; memo = null; caller = principal "'"$DEFAULT"'"; } }; done = opt record { ' ' : nat64; variant { Ok = "1_000_000_000_000_000_000" }; }; traces = vec { record { ' ' : nat64; "*Transfer* `token:[ss2fx-dyaaa-aaaar-qacoq-cai], from:('"$DEFAULT"'.), to:('"$ALICE"'.), amount:1_000_000_000_000_000_000`"; }; record { '
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(2:nat64)" 2>&1)" ' : nat64; "Transfer Done: 1_000_000_000_000_000_000."; }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; account = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; }; record { token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; account = record { owner = principal "'"$ALICE"'"; subaccount = null; }; }; }; }; index = 2 : nat64; }, )'
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(4:nat64)" --output json 2>&1)" 'invalid block height'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(6:nat64)" --output json 2>&1)" '", "1": { "Ok": "{\"amount\":[\"1_000_000_000_000_001_118\",\"200_000_000_000\"]}" } } ], "index": "6", "locks": { "balances": [ [ { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 17, 223, 250, 53, 253, 66, 129, 15, 155, 36, 156, 57, 116, 157, 74, 220, 115, 163, 151, 247, 153, 249, 7, 3, 191, 109, 143, 204, 30, 247, 217, 44 ] ] }, "token": "ss2fx-dyaaa-aaaar-qacoq-cai" }, { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 17, 223, 250, 53, 253, 66, 129, 15, 155, 36, 156, 57, 116, 157, 74, 220, 115, 163, 151, 247, 153, 249, 7, 3, 191, 109, 143, 204, 30, 247, 217, 44 ] ] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ss2fx-dyaaa-aaaar-qacoq-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } ] ], "swap": [ true ], "token": [ true ] }, "traces": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(6:nat64)" --output json 2>&1)" '", "1": "*Remove Liquidity* `tokenA:[ss2fx-dyaaa-aaaar-qacoq-cai], tokenB:[cngnf-vqaaa-aaaar-qag4q-cai], amm:swap_v2_0.3%, liquidity:447_213_595_499_958, required: 1 <= amount_a && 1 <= amount_b`" }, { "0": "' '", "1": "*Burn Liquidity (Withdraw)*. `token:[vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4], from[burned liquidity]:('"$DEFAULT"'.), to[withdrawn 2 tokens]:('"$DEFAULT"'.) amount:447_213_595_499_958`" }, { "0": "' '", "1": "*Burn Liquidity* `token:[vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4], from:('"$DEFAULT"'.), amount:447_213_595_499_958`" }, { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(6:nat64)" --output json 2>&1)" '", "1": "*Transfer Token* `token:[ss2fx-dyaaa-aaaar-qacoq-cai], from:(piwiu-wiaaa-aaaaj-azzka-cai.11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c), to:('"$DEFAULT"'.), amount:1_000_000_000_000_001_118, done:1_000_000_000_000_001_118`" }, { "0": "' '", "1": "*Transfer Token* `token:[cngnf-vqaaa-aaaar-qag4q-cai], from:(piwiu-wiaaa-aaaaj-azzka-cai.11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c), to:('"$DEFAULT"'.), amount:200_000_000_000, done:200_000_000_000`" }, { "0": "' '", "1": "*Pair Cumulative Price* `pa:([ss2fx-dyaaa-aaaar-qacoq-cai],[cngnf-vqaaa-aaaar-qag4q-cai],swap_v2_0.3%), timestamp:' ', exponent:64, price0_cumulative:' ', price1_cumulative:' '`" }, { "0": "' '", "1": "Token Pair Remove Liquidity Done." } ] } ]'
...
test "pair_create" "$(dfx --identity default canister call core pair_create "(record { pool=record{ token0=principal \"$token_ICP\"; token1=principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\" }})" 2>&1)" '( variant { Ok = variant { swap_v2 = record { lp = variant { inner = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 0 : nat; } }; price_cumulative_exponent = 64 : nat8; block_timestamp_last = 0 : nat64; reserve0 = "0"; reserve1 = "0"; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = "0"; token0 = "ryjl3-tyaaa-aaaaa-aaaba-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = "0"; protocol_fee = opt "1/6"; price0_cumulative_last = "0"; } } }, )'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(4:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "create": { "creator": "'"$DEFAULT"'", "pa": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } } } } }'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(7:nat64)" --output json 2>&1)" '[ { "args": { "pair_create": { "arg": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } }, "caller": "'"$DEFAULT"'", "created": [], "memo": [], "now": "' '" } }, "done": [ { "0": "' '", "1": { "Ok": "{\"swap_v2\":{\"subaccount\":\"81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996\",\"fee_rate\":\"3/1000\",\"token0\":\"ryjl3-tyaaa-aaaaa-aaaba-cai\",\"token1\":\"cngnf-vqaaa-aaaar-qag4q-cai\",\"reserve0\":\"0\",\"reserve1\":\"0\",\"block_timestamp_last\":0,\"price_cumulative_exponent\":64,\"price0_cumulative_last\":\"0\",\"price1_cumulative_last\":\"0\",\"k_last\":\"0\",\"lp\":{\"inner\":{\"dummy_canister_id\":\"kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk\",\"total_supply\":[],\"decimals\":7,\"fee\":[10000],\"minimum_liquidity\":[10000000]}},\"protocol_fee\":\"1/6\"}}" } } ], "index": "7", "locks": { "balances": [], "swap": [ true ], "token": [] }, "traces": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(7:nat64)" --output json 2>&1)" '", "1": "*CreateTokenPair* `token0:[ryjl3-tyaaa-aaaaa-aaaba-cai], token1:[cngnf-vqaaa-aaaar-qag4q-cai], amm:swap_v2_0.3%, subaccount:(81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), dummyCanisterId:[kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk]`" } ] } ]'
test "pair_query" "$(dfx --identity alice canister call core pair_query "(record { token0 = principal \"$token_ICP\"; token1 = principal \"$token_ckUSDT\"; amm = \"swap_v2_0.3%\"; })" >&1)" '( opt variant { swap_v2 = record { lp = variant { inner = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 0 : nat; } }; price_cumulative_exponent = 64 : nat8; block_timestamp_last = 0 : nat64; reserve0 = "0"; reserve1 = "0"; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = "0"; token0 = "ryjl3-tyaaa-aaaaa-aaaba-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = "0"; protocol_fee = opt "1/6"; price0_cumulative_last = "0"; } }, )'
...
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(10:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "deposit": { "amount": "20_000_000_000", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" } } } } }'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(8:nat64)" --output json 2>&1)" '[ { "args": { "token_deposit": { "arg": { "amount": "20_000_000_000", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, "caller": "'"$DEFAULT"'", "created": [], "memo": [], "now": "' '" } }, "done": [ { "0": "' '", "1": { "Ok": "2" } } ], "index": "8", "locks": { "balances": [ [ { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" } ] ], "swap": [], "token": [ true ] }, "traces": [ { "0": "' '", "1": "*Deposit* `token:[ryjl3-tyaaa-aaaaa-aaaba-cai], from:('"$DEFAULT"'.), to:('"$DEFAULT"'.), amount:20_000_000_000, height:2`" }, { "0": "' '", "1": "Deposit Done." } ] } ]'
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(5:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "swap_v2": { "mint": { "amount": "44_721_359_549", "amount0": "10_000_000_000", "amount1": "200_000_000_000", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "pa": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk", "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } } } }'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(9:nat64)" --output json 2>&1)" '[ { "args": { "pair_liquidity_add": { "arg": { "amount_a_desired": "10_000_000_000", "amount_a_min": "1", "amount_b_desired": "200_000_000_000", "amount_b_min": "1", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "pa": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } }, "self_canister": "piwiu-wiaaa-aaaaj-azzka-cai", "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token_a": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token_b": "cngnf-vqaaa-aaaar-qag4q-cai" }, "caller": "'"$DEFAULT"'", "created": [], "memo": [], "now": "' '" } }, "done": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(9:nat64)" --output json 2>&1)" '", "1": { "Ok": "{\"amount\":[\"10_000_000_000\",\"200_000_000_000\"],\"liquidity\":\"44_721_359_549\"}" } } ], "index": "9", "locks": { "balances": [ [ { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } ] ], "swap": [ true ], "token": [ true ] }, "traces": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(9:nat64)" --output json 2>&1)" '", "1": "*Add Liquidity* `tokenA:[ryjl3-tyaaa-aaaaa-aaaba-cai], tokenB:[cngnf-vqaaa-aaaar-qag4q-cai], amm:swap_v2_0.3%, required: 1 <= amount_a <= 10_000_000_000 && 1 <= amount_b <= 200_000_000_000`" }, { "0": "' '", "1": "*Add Liquidity* `amount_a:10_000_000_000, amount_b:200_000_000_000`" }, { "0": "' '", "1": "*Transfer Token* `token:[ryjl3-tyaaa-aaaaa-aaaba-cai], from:('"$DEFAULT"'.), to:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), amount:10_000_000_000, done:10_000_000_000`" }, { "0": "' '", "1": "*Transfer Token* `token:[cngnf-vqaaa-aaaar-qag4q-cai], from:('"$DEFAULT"'.), to:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), amount:200_000_000_000, done:200_000_000_000`" }, { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(9:nat64)" --output json 2>&1)" '", "1": "*Mint Liquidity (Deposit)* `token:[kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk], from[transferred 2 tokens]:('"$DEFAULT"'.), to[minted liquidity]:('"$DEFAULT"'.), amount:44_721_359_549`" }, { "0": "' '", "1": "*Mint Liquidity* `token:[kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk], to:('"$DEFAULT"'.), amount:44_721_359_549`" }, { "0": "' '", "1": "Token Pair Add Liquidity Done." } ] } ]'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(11:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "10_000_000_000", "fee": [], "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(12:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "200_000_000_000", "fee": [], "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(13:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "deposit": { "amount": "44_721_359_549", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk" } } } } }'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" 2>&1)" '(null)'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(14:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(6:nat64)" --output json 2>&1)" 'invalid block height'
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(6:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "swap_v2": { "cumulative_price": { "block_timestamp": "' '", "pa": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } }, "price0_cumulative": "' '", "price1_cumulative": "' '", "price_cumulative_exponent": 64 } } } } } } }'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(7:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "swap": { "amm": { "swap_v2_0.3%": null }, "amount_a": "100_000_000", "amount_b": "1_974_316_068", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token_a": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token_b": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } } }'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(8:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(14:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "100_000_000", "fee": [], "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(15:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "1_974_316_068", "fee": [], "from": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(16:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" --output json 2>&1)" '[ { "args": { "pair_swap_exact_tokens_for_tokens": { "arg": { "amount_in": "100_000_000", "amount_out_min": "1_000_000_000", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "pas": [ { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } } ], "path": [ { "amm": "swap_v2_0.3%", "token": { "0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "1": "cngnf-vqaaa-aaaar-qag4q-cai" } } ], "self_canister": "piwiu-wiaaa-aaaaj-azzka-cai", "to": { "owner": "'"$DEFAULT"'", "subaccount": [] } }, "caller": "'"$DEFAULT"'", "created": [], "memo": [], "now": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" --output json 2>&1)" '" } }, "done": [ { "0": "' '", "1": { "Ok": "{\"amounts\":[\"100_000_000\",\"1_974_316_068\"]}" } } ], "index": "10", "locks": { "balances": [ [ { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } ] ], "swap": [ true ], "token": [ true ] }, "traces": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" --output json 2>&1)" '", "1": "*Transfer Token* `token:[ryjl3-tyaaa-aaaaa-aaaba-cai], from:('"$DEFAULT"'.), to:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), amount:100_000_000, done:100_000_000`" }, { "0": "' '", "1": "*Transfer Token* `token:[cngnf-vqaaa-aaaar-qag4q-cai], from:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), to:('"$DEFAULT"'.), amount:1_974_316_068, done:1_974_316_068`" }, { "0": "' '", "1": "*Pair Cumulative Price* `pa:([ryjl3-tyaaa-aaaaa-aaaba-cai],[cngnf-vqaaa-aaaar-qag4q-cai],swap_v2_0.3%), timestamp:' ', exponent:64, price0_cumulative:' ', price1_cumulative:' '`" }, { "0": "' '", "1": "*Pair Swap Token* `swap_pair:([ryjl3-tyaaa-aaaaa-aaaba-cai],[cngnf-vqaaa-aaaar-qag4q-cai],swap_v2_0.3%), from:('"$DEFAULT"'.), to:('"$DEFAULT"'.), pay_amount:100_000_000, got_amount:1_974_316_068`" }, { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(10:nat64)" --output json 2>&1)" '", "1": "Token Pair Swap Exact Tokens for Tokens Done." } ] } ]'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" 2>&1)" '(null)'
...
test "pair_query" "$(dfx --identity alice canister call core pair_query "(record { token0 = principal \"$token_ICP\"; token1 = principal \"$token_ckUSDT\"; amm = \"swap_v2_0.3%\"; })" >&1)" '( opt variant { swap_v2 = record { lp = variant { inner = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 44_721_359_549 : nat; } }; price_cumulative_exponent = 64 : nat8; block_timestamp_last = ' ' : nat64; reserve0 = "10_100_000_000"; reserve1 = "198_025_683_932"; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = "' '"; token0 = "ryjl3-tyaaa-aaaaa-aaaba-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = "0"; protocol_fee = opt "1/6"; price0_cumulative_last = "' '"; } }, )'
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(8:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "swap_v2": { "cumulative_price": { "block_timestamp": "' '", "pa": { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } }, "price0_cumulative": "' '", "price1_cumulative": "' '", "price_cumulative_exponent": 64 } } } } } } }'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(9:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "pair": { "swap": { "amm": { "swap_v2_0.3%": null }, "amount_a": "1_314_083", "amount_b": "25_683_932", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token_a": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token_b": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } } }'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(10:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(16:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "1_314_083", "fee": [], "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "to": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(17:nat64)" --output json 2>&1)" '{ "block": { "parent_hash": [' '], "timestamp": "' '", "transaction": { "created": [], "memo": [], "operation": { "transfer": { "amount": "25_683_932", "fee": [], "from": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "to": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } } } } }'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(18:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" --output json 2>&1)" '[ { "args": { "pair_swap_tokens_for_exact_tokens": { "arg": { "amount_in_max": "1_314_083", "amount_out": "25_683_932", "from": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "pas": [ { "amm": { "swap_v2_0.3%": null }, "pair": { "token0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "token1": "cngnf-vqaaa-aaaar-qag4q-cai" } } ], "path": [ { "amm": "swap_v2_0.3%", "token": { "0": "ryjl3-tyaaa-aaaaa-aaaba-cai", "1": "cngnf-vqaaa-aaaar-qag4q-cai" } } ], "self_canister": "piwiu-wiaaa-aaaaj-azzka-cai", "to": { "owner": "'"$DEFAULT"'", "subaccount": [] } }, "caller": "'"$DEFAULT"'", "created": [], "memo": [], "now": "' '" } }, "done": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" --output json 2>&1)" '", "1": { "Ok": "{\"amounts\":[\"1_314_083\",\"25_683_932\"]}" } } ], "index": "11", "locks": { "balances": [ [ { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "piwiu-wiaaa-aaaaj-azzka-cai", "subaccount": [ [ 129, 192, 159, 10, 187, 219, 171, 138, 212, 6, 16, 125, 179, 209, 133, 136, 182, 103, 235, 148, 243, 190, 106, 85, 108, 227, 107, 136, 117, 203, 137, 150 ] ] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "ryjl3-tyaaa-aaaaa-aaaba-cai" }, { "account": { "owner": "'"$DEFAULT"'", "subaccount": [] }, "token": "cngnf-vqaaa-aaaar-qag4q-cai" } ] ], "swap": [ true ], "token": [ true ] }, "traces": [ { "0": "'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" --output json 2>&1)" '", "1": "*Transfer Token* `token:[ryjl3-tyaaa-aaaaa-aaaba-cai], from:('"$DEFAULT"'.), to:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), amount:1_314_083, done:1_314_083`" }, { "0": "' '", "1": "*Transfer Token* `token:[cngnf-vqaaa-aaaar-qag4q-cai], from:(piwiu-wiaaa-aaaaj-azzka-cai.81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996), to:('"$DEFAULT"'.), amount:25_683_932, done:25_683_932`" }, { "0": "' '", "1": "*Pair Cumulative Price* `pa:([ryjl3-tyaaa-aaaaa-aaaba-cai],[cngnf-vqaaa-aaaar-qag4q-cai],swap_v2_0.3%), timestamp:'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(11:nat64)" --output json 2>&1)" ', exponent:64, price0_cumulative:' ', price1_cumulative:' '`" }, { "0": "' '", "1": "*Pair Swap Token* `swap_pair:([ryjl3-tyaaa-aaaaa-aaaba-cai],[cngnf-vqaaa-aaaar-qag4q-cai],swap_v2_0.3%), from:('"$DEFAULT"'.), to:('"$DEFAULT"'.), pay_amount:1_314_083, got_amount:25_683_932`" }, { "0": "' '", "1": "Token Pair Swap Tokens for Exact Tokens Done." } ] } ]'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(12:nat64)" 2>&1)" '(null)'
...
test "pair_query" "$(dfx --identity alice canister call core pair_query "(record { token0 = principal \"$token_ICP\"; token1 = principal \"$token_ckUSDT\"; amm = \"swap_v2_0.3%\"; })" >&1)" '( opt variant { swap_v2 = record { lp = variant { inner = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 44_721_359_549 : nat; } }; price_cumulative_exponent = 64 : nat8; block_timestamp_last = ' ' : nat64; reserve0 = "10_101_314_083"; reserve1 = "198_000_000_000"; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = "' '"; token0 = "ryjl3-tyaaa-aaaaa-aaaba-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = "0"; protocol_fee = opt "1/6"; price0_cumulative_last = "' '"; } }, )'
...
test "pair_create" "$(dfx --identity default canister call core pair_create "(record { pool=record{ token0=principal \"$token_ICP\"; token1=principal \"$token_ckETH\"; amm=\"swap_v2_0.3%\"} })" 2>&1)" '(variant { Ok })'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(10:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(12:nat64)" --output json 2>&1)" '(null)'
...
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(18:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(19:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(20:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(11:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(13:nat64)" --output json 2>&1)" '(null)'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(14:nat64)" --output json 2>&1)" '(null)'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(21:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(12:nat64)" --output json 2>&1)" 'invalid block height'
start_time_s0=$(date +%s)
...
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(12:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(13:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(14:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(15:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(16:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(17:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_swap_get" "$(dfx --identity default canister call core block_swap_get "(18:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(21:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(22:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(23:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(24:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(25:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(26:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ block_token_get" "$(dfx --identity default canister call core block_token_get "(27:nat64)" --output json 2>&1)" 'invalid block height'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(14:nat64)" 2>&1)" '(null)'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(15:nat64)" 2>&1)" '(null)'
