...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(0:nat64)" 2>&1)" '( opt record { args = variant { token_deposit = record { arg = record { to = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; from = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; amount = 5_000_000_000_000_000_000 : nat; }; now = ' ' : nat64; created = null; memo = null; caller = principal "'"$DEFAULT"'"; } }; done = opt record { ' ' : nat64; variant { Ok = "4" }; }; traces = vec { record { ' ' : nat64; "Deposit 5_000_000_000_000_000_000 Token: [ss2fx-dyaaa-aaaar-qacoq-cai] From: ('"$DEFAULT"'.) To: ('"$DEFAULT"'.) With Height: 4."; }; record { ' ' : nat64; "Deposit Done." }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; account = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; }; }; }; index = 0 : nat64; }, )'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(2:nat64)" 2>&1)" '( opt record { args = variant { token_transfer = record { arg = record { to = record { owner = principal "m7ykr-tyngj-c64l5-xpjju-ngtfh-crmaq-qmedt-3lebc-tpxkq-koiel-zqe"; subaccount = null; }; fee = null; token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; from = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; amount = 1_000_000_000_000_000_000 : nat; }; now = ' ' : nat64; created = null; memo = null; caller = principal "'"$DEFAULT"'"; } }; done = opt record { ' ' : nat64; variant { Ok = "1_000_000_000_000_000_000" }; }; traces = vec { record { ' ' : nat64; "Transfer 1_000_000_000_000_000_000 Token: [ss2fx-dyaaa-aaaar-qacoq-cai] From ('"$DEFAULT"'.) To: (m7ykr-tyngj-c64l5-xpjju-ngtfh-crmaq-qmedt-3lebc-tpxkq-koiel-zqe.)."; }; record { ' ' : nat64; "Transfer Done: 1_000_000_000_000_000_000."; }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; account = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; }; record { token = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; account = record { owner = principal "m7ykr-tyngj-c64l5-xpjju-ngtfh-crmaq-qmedt-3lebc-tpxkq-koiel-zqe"; subaccount = null; }; }; }; }; index = 2 : nat64; }, )'
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(4:nat64)" 2>&1)" '( opt record { args = variant { token_deposit = record { arg = record { to = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; token = principal "cngnf-vqaaa-aaaar-qag4q-cai"; from = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; amount = 800_000_000_000 : nat; }; now = ' ' : nat64; created = null; memo = null; caller = principal "'"$DEFAULT"'"; } }; done = opt record { ' ' : nat64; variant { Ok = "2" }; }; traces = vec { record { ' ' : nat64; "Deposit 800_000_000_000 Token: [cngnf-vqaaa-aaaar-qag4q-cai] From: ('"$DEFAULT"'.) To: ('"$DEFAULT"'.) With Height: 2."; }; record { ' ' : nat64; "Deposit Done." }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal "cngnf-vqaaa-aaaar-qag4q-cai"; account = record { owner = principal "'"$DEFAULT"'"; subaccount = null; }; }; }; }; index = 4 : nat64; }, )'
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(5:nat64)" --output json 2>&1)" '[]'
