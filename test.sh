...
test "pairs_query" "$(dfx --identity alice canister call swap pairs_query 2>&1)" '( vec { record { record { amm = "swap_v2_0.3%"; pair = record { principal "ss2fx-dyaaa-aaaar-qacoq-cai"; principal "cngnf-vqaaa-aaaar-qag4q-cai"; }; }; variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 894_427_190_999_915 : nat; } }; block_timestamp_last = ' ' : nat64; reserve0 = 2_000_000_000_000_000_000 : nat; reserve1 = 400_000_000_000 : nat; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = 0 : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = 0 : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }; }; }, )'
test "pair_query" "$(dfx --identity alice canister call swap pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ckETH\"; principal \"$token_ckUSDT\"; }; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 894_427_190_999_915 : nat; } }; block_timestamp_last = ' ' : nat64; reserve0 = 2_000_000_000_000_000_000 : nat; reserve1 = 400_000_000_000 : nat; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = 0 : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = 0 : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }, )'
...
test "pair_query" "$(dfx --identity alice canister call swap pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ckETH\"; principal \"$token_ckUSDT\"; }; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 447_213_595_499_957 : nat; } }; block_timestamp_last = ' ' : nat64; reserve0 = 999_999_999_999_998_882 : nat; reserve1 = 200_000_000_000 : nat; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = ' ' : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = ' ' : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }, )'
...
test "pair_query" "$(dfx --identity alice canister call swap pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ICP\"; principal \"$token_ckUSDT\"; }; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 0 : nat; } }; block_timestamp_last = 0 : nat64; reserve0 = 0 : nat; reserve1 = 0 : nat; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = 0 : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = 0 : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }, )'
...
test "pair_query" "$(dfx --identity alice canister call swap pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ICP\"; principal \"$token_ckUSDT\"; }; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 44_721_359_549 : nat; } }; block_timestamp_last = ' ' : nat64; reserve0 = 10_100_000_000 : nat; reserve1 = 198_025_683_932 : nat; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = ' ' : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = ' ' : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }, )'
...
test "pair_query" "$(dfx --identity alice canister call swap pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ICP\"; principal \"$token_ckUSDT\"; }; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 10_000 : nat; decimals = 7 : nat8; dummy_canister_id = principal "kvdti-w4byc-pqvo6-3vofn-ibqqp-wz5db-miwzt-6xfht-xzvfk-3hdno-ehk"; minimum_liquidity = 10_000_000 : nat; total_supply = 44_721_359_549 : nat; } }; block_timestamp_last = ' ' : nat64; reserve0 = 10_101_314_083 : nat; reserve1 = 198_000_000_000 : nat; subaccount = "81c09f0abbdbab8ad406107db3d18588b667eb94f3be6a556ce36b8875cb8996"; price1_cumulative_last = ' ' : nat; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = ' ' : nat; price_unit = 18_446_744_073_709_551_615 : nat; } }, )'
