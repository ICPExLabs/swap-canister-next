...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(0:nat64)" 2>&1)" "( opt record { args = variant { token_deposit = record { arg = record { token = principal \"ss2fx-dyaaa-aaaar-qacoq-cai\"; from = record { owner = principal \"$DEFAULT\"; subaccount = null; }; amount = 5_000_000_000_000_000_000 : nat; }; now = " " : nat64; created = null; memo = null; caller = principal \"$DEFAULT\"; } }; done = opt record { " " : nat64; variant { Ok = \"4\" }; }; traces = vec { record { " " : nat64; \"Deposit 5_000_000_000_000_000_000 Token: [ss2fx-dyaaa-aaaar-qacoq-cai] From: ($DEFAULT.) With Height: 4.\"; }; record { " " : nat64; \"Deposit Done\" }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal \"ss2fx-dyaaa-aaaar-qacoq-cai\"; account = record { owner = principal \"$DEFAULT\"; subaccount = null; }; }; }; }; index = 0 : nat64; }, )"
...
test "👁︎ request_trace_get" "$(dfx --identity default canister call core request_trace_get "(1:nat64)" 2>&1)" "( opt record { args = variant { token_withdraw = record { arg = record { to = record { owner = principal \"$DEFAULT\"; subaccount = null; }; token = principal \"ss2fx-dyaaa-aaaar-qacoq-cai\"; from = record { owner = principal \"$DEFAULT\"; subaccount = null; }; amount = 1_000_000_000_000_000_000 : nat; }; now = " " : nat64; created = null; memo = null; caller = principal \"$DEFAULT\"; } }; done = opt record { " " : nat64; variant { Ok = \"5\" }; }; traces = vec { record { " " : nat64; \"Withdraw 1_000_000_000_000_000_000 Token: [ss2fx-dyaaa-aaaar-qacoq-cai] To: ($DEFAULT.) With Height: 5.\"; }; record { " " : nat64; \"Withdraw Done\" }; }; locks = record { token = opt true; swap = null; balances = opt vec { record { token = principal \"ss2fx-dyaaa-aaaar-qacoq-cai\"; account = record { owner = principal \"$DEFAULT\"; subaccount = null; }; }; }; }; index = 1 : nat64; }, )"
...
test "pair_create" "$(dfx --identity alice canister call core pair_create "(record { pair_pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; } })" 2>&1)" "Permission 'BusinessTokenPairCreate'"
...
test "pair_create" "$(dfx --identity default canister call core pair_create "(record { pair_pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }})" 2>&1)" '( variant { Ok = variant { swap_v2 = record { lp = variant { inner = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 0 : nat; } }; price_cumulative_exponent = 64 : nat8; block_timestamp_last = 0 : nat64; reserve0 = "0"; reserve1 = "0"; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = "0"; token0 = "ss2fx-dyaaa-aaaar-qacoq-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = "0"; protocol_fee = opt "1/6"; price0_cumulative_last = "0"; } } }, )'
...
test "token_deposit" "$(dfx --identity default canister call core token_deposit "(record { token=principal \"$token_ckUSDT\"; from=record{owner=principal \"$DEFAULT\"; subaccount=null}; amount_without_fee=800_000_000_000: nat }, null)" 2>&1)" '(variant { Ok = 2 : nat })'
test "pair_liquidity_add" "$(dfx --identity default canister call core pair_liquidity_add "(record { from=record{owner=principal\"$DEFAULT\"}; pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }; amount_desired=record{2_000_000_000_000_000_000:nat;400_000_000_000:nat}; amount_min=record{1:nat;1:nat}; to=record{owner=principal\"$DEFAULT\"}; deadline=null } , null)" 2>&1)" '( variant { Ok = record { liquidity = 894_427_190_999_915 : nat; amount = record { 2_000_000_000_000_000_000 : nat; 400_000_000_000 : nat; }; } }, )'
test "pairs_query" "$(dfx --identity alice canister call core pairs_query 2>&1)" '( vec { record { record { amm = "swap_v2_0.3%"; token0 = principal "ss2fx-dyaaa-aaaar-qacoq-cai"; token1 = principal "cngnf-vqaaa-aaaar-qag4q-cai"; }; variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 894_427_190_999_915 : nat; } }; block_timestamp_last = ' ' : nat64; price_cumulative_unit = 18_446_744_073_709_551_615 : nat; reserve0 = 2_000_000_000_000_000_000 : nat; reserve1 = 400_000_000_000 : nat; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = 0 : nat; token0 = "ss2fx-dyaaa-aaaar-qacoq-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = 0 : nat; } }; }; }, )'
test "pair_query" "$(dfx --identity alice canister call core pair_query "(record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm = \"swap_v2_0.3%\"; })" >&1)" '( opt variant { SwapV2 = record { lp = variant { InnerLP = record { fee = 100_000_000 : nat; decimals = 12 : nat8; dummy_canister_id = principal "vbofh-iir37-5dl7k-cqehz-wje4h-f2j2s-w4oor-zp54z-7edqh-p3nr7-gb4"; minimum_liquidity = 100_000_000_000 : nat; total_supply = 894_427_190_999_915 : nat; } }; block_timestamp_last = ' ' : nat64; price_cumulative_unit = 18_446_744_073_709_551_615 : nat; reserve0 = 2_000_000_000_000_000_000 : nat; reserve1 = 400_000_000_000 : nat; subaccount = "11dffa35fd42810f9b249c39749d4adc73a397f799f90703bf6d8fcc1ef7d92c"; price1_cumulative_last = 0 : nat; token0 = "ss2fx-dyaaa-aaaar-qacoq-cai"; token1 = "cngnf-vqaaa-aaaar-qag4q-cai"; fee_rate = "3/1000"; k_last = 0 : nat; protocol_fee = opt "1/6"; price0_cumulative_last = 0 : nat; } }, )'
...
test "pair_liquidity_remove" "$(dfx --identity default canister call core pair_liquidity_remove "(record { from=record{owner=principal\"$DEFAULT\"}; pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }; liquidity=1_894_427_190_999_915:nat; amount_min=record{1:nat;1:nat}; to=record{owner=principal\"$DEFAULT\"}; deadline=null } , null)" 2>&1)" '(variant { Err = variant { Liquidity = "INSUFFICIENT_LIQUIDITY" } })'
test "pair_liquidity_remove" "$(dfx --identity default canister call core pair_liquidity_remove "(record { from=record{owner=principal\"$DEFAULT\"}; pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }; liquidity=894_427_190_999_915:nat; amount_min=record{1:nat;1:nat}; to=record{owner=principal\"$DEFAULT\"}; deadline=null } , null)" 2>&1)" '(variant { Err = variant { Liquidity = "REMAIN_TOTAL_LIQUIDITY_TOO_SMALL" } })'
test "pair_liquidity_remove" "$(dfx --identity default canister call core pair_liquidity_remove "(record { from=record{owner=principal\"$DEFAULT\"}; pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }; liquidity=447_213_595_499_958:nat; amount_min=record{1:nat;1:nat}; to=record{owner=principal\"$DEFAULT\"}; deadline=null } , null)" 2>&1)" '( variant { Ok = record { amount = record { 1_000_000_000_000_001_118 : nat; 200_000_000_000 : nat; }; } }, )'
...
test "token_deposit" "$(dfx --identity default canister call core token_deposit "(record { token=principal \"$token_ICP\"; from=record{owner=principal \"$DEFAULT\"; subaccount=null}; amount_without_fee=20_000_000_000: nat }, null)" 2>&1)" '(variant { Ok = 2 : nat })'
...
test "pair_liquidity_remove" "$(dfx --identity default canister call core pair_liquidity_remove "(record { from=record{owner=principal\"$DEFAULT\"}; pool=record { token0 = principal \"$token_ckETH\"; token1 = principal \"$token_ckUSDT\"; amm=\"swap_v2_0.3%\"; }; liquidity=1_000_000:nat; amount_min=record{1:nat;1:nat}; to=record{owner=principal\"$DEFAULT\"}; deadline=null } , null)" 2>&1)" '(variant { Ok = record { amount = record { 2_236_063_620 : nat; 447 : nat } } })'
