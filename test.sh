...
test "token_deposit" "$(dfx --identity default canister call swap token_deposit "(record { canister_id=principal \"$token_ckUSDT\"; from=record{owner=principal \"$DEFAULT\"; subaccount=null}; amount_without_fee=800_000_000_000: nat }, null)" 2>&1)" '(variant { Ok = 2 : nat })'
