...
test "pair_query" "$(dfx --identity alice canister call core pair_query "(record { amm = \"swap_v2_0.3%\"; pair = record { principal \"$token_ckETH\"; principal \"$token_ckUSDT\"; }; })" >&1)" '(null)'
